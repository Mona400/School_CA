...
namespace School.Core.Features.Authentication.Commands.Handlers
{
        ...
        IRequestHandler<SignInCommand, Response<string>>
    {
        ...
        public async Task<Response<string>> Handle(SignInCommand request, CancellationToken cancellationToken)
        {
            ...
            if (user == null) { return BadRequest<string>(_stringLocalizer[SharedResoursesKeys.UserNameIsNotExist]); }
            //try to sign in
            ...
            {
                return BadRequest<string>(_stringLocalizer[SharedResoursesKeys.PasswordNotCorrect]);
            }
            //generate token
